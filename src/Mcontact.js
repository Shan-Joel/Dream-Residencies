      ...
      <div>
        ...
        <Card style={{maxWidth:650, margin:"0 auto" ,padding:"20px 5px"}}>
          <CardContent>
            ...
            <Typography gutterBottom color="textSecondary" variant='body2' component="p">You can contact us from here for further clarifications.After you fill the below form, our member will contact you soon.</Typography><br></br>
            <form>
